...
public class AdapterFAQ extends ArrayAdapter<FAQModule> {
	
	//variables
		Activity activity;

		public AdapterFAQ(Activity _activity) {
			super(_activity, R.layout.cell_row	, DATA.arrlstFAQModules);
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			convertView.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					String url =  DATA.arrlstFAQModules.get(position).url;
